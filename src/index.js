...
var App = React.createClass({
  ...
  newCardsClicked: function() {
    this.setState({
      hand: getDeck().shuffle().splice(0,5)
    })
  },
  render: function() {
    var caryisamazing = this.state.hand.map(function(card){
      return <Card extreme={card} />
    })
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="col-sm-2">
            <h1><a href="#" className="btn btn-success" onClick={this.newCardsClicked}>Deal</a></h1>
          </div>
        </div>
      </div>
    )
